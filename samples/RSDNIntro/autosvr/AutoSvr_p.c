...
/* Object interface: IMath, ver. 0.0,
   GUID={0x8C30BC10,0xB8F2,0x11D0,{0xA7,0x56,0xB0,0x4A,0x12,0x00,0x00,0x00}} */
...
CINTERFACE_PROXY_VTABLE(11) _IMathProxyVtbl = 
{
    ...
    (void *) (INT_PTR) -1 /* IMath::Subtract */ ,
    (void *) (INT_PTR) -1 /* IMath::Multiply */ ,
    (void *) (INT_PTR) -1 /* IMath::Divide */
};
